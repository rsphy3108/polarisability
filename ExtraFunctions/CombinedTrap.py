...
from AtomFieldInt_V3 import (atom , dipole, c, eps0, h, hbar, a0, e, me, 
    kB, amu, Eh, au)
...
Rb880 = dipole(Rb, (0,1/2.,1,1), [Rbwl, abs(Rbpower), Rbwaist])

# ground state Cs 6 S 1/2
Cs880 = dipole(Cs, (0,1/2.,3,3), [Rbwl, abs(Rbpower), Rbwaist])
